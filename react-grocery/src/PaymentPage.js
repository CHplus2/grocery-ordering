...
export default function PaymentPage() {
    const { total, placeOrder, setAlert, wallet, walletLoading, createWallet, topupWallet } = useCart();
    ...
    return (    
        <div className="payment-container">
            ...
            <div className="wallet-box">
                ...
                <p><strong>Total:</strong> {total.toFixed(2)} TFT</p>
                ...
                <div className="topup-section">
                    ...
                    Insufficient balance. You need {(total - wallet.balance).toFixed(2)} TFT more.
                    </p>
                ...
                <button className="primary-btn" onClick={handlePay} disabled={paying}>
                    {paying ? "Processing..." : `Pay ${total.toFixed(2)} TFT`}
                </button>
                )}
            </div>
            )}
